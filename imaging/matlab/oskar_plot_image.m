...
bottom = (screen_size(4) - (height + 150));
...
xlabel('Relative RA * cos(Dec) [deg]', 'FontSize', 14, 'FontName', 'Arial');
ylabel('Relative Dec [deg]', 'FontSize', 14, 'FontName', 'Arial');
%title([fig_title ...
...
%max(Image(:))
%min(Image(:))
ylabel(c, 'Brightness', 'FontName', 'Arial', 'FontSize', 12);
axis square;
grid on;
