...
OSKAR_DFTW_M2M_CPU( M_CAT(dftw_m2m_2d_, Real), false, Real, Real2, Real4c)
OSKAR_DFTW_M2M_CPU( M_CAT(dftw_m2m_3d_, Real), true, Real, Real2, Real4c)
OSKAR_DFTW_O2C_CPU( M_CAT(dftw_o2c_2d_, Real), false, Real, Real2)
OSKAR_DFTW_O2C_CPU( M_CAT(dftw_o2c_3d_, Real), true, Real, Real2)
