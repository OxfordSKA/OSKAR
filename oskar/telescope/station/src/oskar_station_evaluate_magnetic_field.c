...
)
{
     ...
     * Therefore we need to swap X and Y, and negate Z.
     */
    station->magnetic_field[0] = y;
    station->magnetic_field[1] = x;
    station->magnetic_field[2] = -z;
    station->magnetic_field[3] = f;
}

/*
 * Translated from FORTRAN 77 version in igrf14.f
 * from https://www.ngdc.noaa.gov/IAGA/vmod/igrf14.f
 */

/*
 * This is a synthesis routine for the 14th generation IGRF as agreed
 * in December 2024 by IAGA Working Group V-MOD. It is valid 1900.0 to
 * 2030.0 inclusive. Values for dates from 1945.0 to 2020.0 inclusive are
 ...
 *           less than or equal to 2035.0. Must be double precision.
 ...
 * by William Brown, December 2019, February 2020. Updated by
 * Ciaran Beggan, November 2024
 *
...
)
{
        ...
        -29441.46,-1501.77, 4795.99,-2445.88, 3012.20,-2845.41,    /* 2015 */
          ...
          -119.14, -157.40,   15.98,    4.30,  100.12,   69.55,    /* 2015 */
           ...
           -16.78,  -18.26,   -3.16,   13.18,  -20.56,  -14.60,    /* 2015 */
            ...
            -0.43,   -0.36,   -0.71,                               /* 2015 */
        -29403.41,-1451.37, 4653.35,-2499.78, 2981.96,-2991.72,    /* 2020 */
          1676.85, -734.62, 1363.00,-2380.80,  -81.96, 1236.06,    /* 2020 */
           241.80,  525.60, -542.52,  902.82,  809.47,  282.10,    /* 2020 */
            86.18, -158.50, -309.47,  199.75,   47.44, -350.30,    /* 2020 */
          -234.42,  363.26,   47.52,  187.86,  208.36, -140.73,    /* 2020 */
          -121.43, -151.16,   32.09,   13.98,   99.14,   65.97,    /* 2020 */
            65.56,  -19.22,   72.96,   25.02, -121.57,   52.76,    /* 2020 */
           -36.06,  -64.40,   13.60,    8.96,  -64.80,   68.04,    /* 2020 */
            80.54,  -76.63,  -51.50,   -8.23,  -16.85,   56.45,    /* 2020 */
             2.36,   15.80,   23.56,    6.30,   -2.19,   -7.21,    /* 2020 */
           -27.19,    9.77,   -1.90,   23.66,    9.74,    8.43,    /* 2020 */
           -17.49,  -15.23,   -0.49,   12.83,  -21.07,  -11.76,    /* 2020 */
            15.28,   14.94,   13.65,    3.62,  -16.59,   -6.90,    /* 2020 */
            -0.34,    2.90,    5.03,    8.36,  -23.44,    2.84,    /* 2020 */
            11.04,   -1.48,    9.86,   -1.14,   -5.13,  -13.22,    /* 2020 */
            -6.20,    1.08,    7.79,    8.82,    0.40,   -9.23,    /* 2020 */
            -1.44,  -11.86,    9.60,   -1.84,   -6.25,    3.38,    /* 2020 */
            -0.11,   -0.18,    1.66,    3.50,   -0.86,    4.86,    /* 2020 */
             0.65,   -8.62,   -0.88,   -0.11,    1.88,   -4.26,    /* 2020 */
             1.44,   -3.43,   -2.38,   -0.10,   -3.84,   -8.84,    /* 2020 */
             2.96,   -1.36,   -0.02,   -2.51,    2.50,    2.31,    /* 2020 */
            -0.55,   -0.85,   -0.39,    0.28,    0.62,   -0.66,    /* 2020 */
            -0.21,   -0.07,   -1.66,    1.44,   -1.60,   -0.59,    /* 2020 */
            -2.98,    0.18,   -1.97,    3.09,   -2.51,   -2.00,    /* 2020 */
            -0.13,   -1.15,    0.43,    0.52,    1.28,    1.37,    /* 2020 */
            -1.14,   -1.81,    0.71,    0.08,    0.31,    0.71,    /* 2020 */
             0.49,   -0.15,   -0.26,    0.55,   -0.47,    0.16,    /* 2020 */
             0.09,   -0.93,   -1.13,   -0.04,   -0.33,    0.52,    /* 2020 */
             0.08,   -0.93,   -0.88,    0.53,    0.64,    0.72,    /* 2020 */
             1.40,   -0.30,   -0.38,    0.75,   -1.31,   -0.01,    /* 2020 */
            -0.09,    0.76,    0.29,   -0.05,   -0.11,    0.37,    /* 2020 */
             0.47,    0.13,    0.54,    0.45,   -0.41,   -0.46,    /* 2020 */
            -0.36,   -0.40,   -0.60,                               /* 2020 */
         -29350.0, -1410.3,  4545.5, -2556.2,  2950.9, -3133.6,    /* 2025 */
           1648.7,  -814.2,  1360.9, -2404.2,   -56.9,  1243.8,    /* 2025 */
            237.6,   453.4,  -549.6,   894.7,   799.6,   278.6,    /* 2025 */
             55.8,  -134.0,  -281.1,   212.0,    12.0,  -375.4,    /* 2025 */
           -232.9,   369.0,    45.3,   187.2,   220.0,  -138.7,    /* 2025 */
           -122.9,  -141.9,    42.9,    20.9,   106.2,    64.3,    /* 2025 */
             63.8,   -18.4,    76.7,    16.8,  -115.7,    48.9,    /* 2025 */
            -40.9,   -59.8,    14.9,    10.9,   -60.8,    72.8,    /* 2025 */
             79.6,   -76.9,   -48.9,    -8.8,   -14.4,    59.3,    /* 2025 */
             -1.0,    15.8,    23.5,     2.5,    -7.4,   -11.2,    /* 2025 */
            -25.1,    14.3,    -2.2,    23.1,    10.9,     7.2,    /* 2025 */
            -17.5,   -12.6,     2.0,    11.5,   -21.8,    -9.7,    /* 2025 */
             16.9,    12.7,    14.9,     0.7,   -16.8,    -5.2,    /* 2025 */
              1.0,     3.9,     4.7,     8.0,   -24.8,     3.0,    /* 2025 */
             12.1,    -0.2,     8.3,    -2.5,    -3.4,   -13.1,    /* 2025 */
             -5.3,     2.4,     7.2,     8.6,    -0.6,    -8.7,    /* 2025 */
              0.8,   -12.8,     9.8,    -1.3,    -6.4,     3.3,    /* 2025 */
              0.2,     0.1,     2.0,     2.5,    -1.0,     5.4,    /* 2025 */
             -0.5,    -9.0,    -0.9,     0.4,     1.5,    -4.2,    /* 2025 */
              0.9,    -3.8,    -2.6,     0.9,    -3.9,    -9.0,    /* 2025 */
              3.0,    -1.4,     0.0,    -2.5,     2.8,     2.4,    /* 2025 */
             -0.6,    -0.6,     0.1,     0.0,     0.5,    -0.6,    /* 2025 */
             -0.3,    -0.1,    -1.2,     1.1,    -1.7,    -1.0,    /* 2025 */
             -2.9,    -0.1,    -1.8,     2.6,    -2.3,    -2.0,    /* 2025 */
             -0.1,    -1.2,     0.4,     0.6,     1.2,     1.0,    /* 2025 */
             -1.2,    -1.5,     0.6,     0.0,     0.5,     0.6,    /* 2025 */
              0.5,    -0.2,    -0.1,     0.8,    -0.5,     0.1,    /* 2025 */
             -0.2,    -0.9,    -1.2,     0.1,    -0.7,     0.2,    /* 2025 */
              0.2,    -0.9,    -0.9,     0.6,     0.7,     0.7,    /* 2025 */
              1.2,    -0.2,    -0.3,     0.5,    -1.3,     0.1,    /* 2025 */
             -0.1,     0.7,     0.2,     0.0,    -0.2,     0.3,    /* 2025 */
              0.5,     0.2,     0.6,     0.4,    -0.6,    -0.5,    /* 2025 */
             -0.3,    -0.4,    -0.5,                               /* 2025 */
             12.6,    10.0,   -21.5,   -11.2,    -5.3,   -27.3,    /* 2027 */
             -8.3,   -11.1,    -1.5,    -4.4,     3.8,     0.4,    /* 2027 */
             -0.2,   -15.6,    -3.9,    -1.7,    -2.3,    -1.3,    /* 2027 */
             -5.8,     4.1,     5.4,     1.6,    -6.8,    -4.1,    /* 2027 */
              0.6,     1.3,    -0.5,     0.0,     2.1,     0.7,    /* 2027 */
              0.5,     2.3,     1.7,     1.0,     1.9,    -0.2,    /* 2027 */
             -0.3,     0.3,     0.8,    -1.6,     1.2,    -0.4,    /* 2027 */
             -0.8,     0.8,     0.4,     0.7,     0.9,     0.9,    /* 2027 */
             -0.1,    -0.1,     0.6,    -0.1,     0.5,     0.5,    /* 2027 */
             -0.7,    -0.1,     0.0,    -0.8,    -0.9,    -0.8,    /* 2027 */
              0.5,     0.9,    -0.3,    -0.1,     0.2,    -0.3,    /* 2027 */
              0.0,     0.4,     0.4,    -0.3,    -0.1,     0.4,    /* 2027 */
              0.3,    -0.5,     0.1,    -0.6,     0.0,     0.3,    /* 2027 */
              0.3,     0.2,     0.0,     0.0,     0.0,     0.0,    /* 2027 */
    ...
    int j = 0, k = 0, l = 0, m = 0, n = 0, nc = 0, ll = 0, kmx = 0;
    double p[105], q[105], cl[13], sl[13];
    double r = 0., t = 0., tc = 0., cd = 0., ct = 0., sd = 0.;
    double fn = 0., gn = 0., rr = 0., st = 0., one = 0., two = 0., three = 0.;

    /* Set initial values. */
    *x = 0.0;
    *y = 0.0;
    *z = 0.0;
    if (date < 1900.0 || date > 2035.0)
    {
    ...
    if (date >= 2025.0)
    {
        ...
        /* Pointer for last coefficient
         * in penultimate set of MF coefficients... */
        ll = 3450;
        const int nmx = 13;
        nc = nmx * (nmx + 2);
        kmx = (nmx + 1) * (nmx + 2) / 2;
    ...
    if (itype == 1)
    {
        ...
        const double a2 = 40680631.6;
        const double b2 = 40408296.0;
        one = a2 * st * st;
        two = b2 * ct * ct;
        three = one + two;
        const double rho = sqrt(three);
        r = sqrt(alt * (alt + rho * 2.0) + (a2 * one + b2 * two) / three);
        cd = (alt + rho) / r;
