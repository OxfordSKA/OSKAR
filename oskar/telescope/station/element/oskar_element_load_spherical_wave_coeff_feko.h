...
#ifndef OSKAR_ELEMENT_LOAD_SPHERICAL_WAVE_COEFF_FEKO_H_
#define OSKAR_ELEMENT_LOAD_SPHERICAL_WAVE_COEFF_FEKO_H_

/**
 * @file oskar_element_load_spherical_wave_coeff_feko.h
 */
