...
#ifndef OSKAR_ELEMENT_LOAD_SPHERICAL_WAVE_COEFF_GALILEO_H_
#define OSKAR_ELEMENT_LOAD_SPHERICAL_WAVE_COEFF_GALILEO_H_

/**
 * @file oskar_element_load_spherical_wave_coeff_galileo.h
 */
 ...
 */
OSKAR_EXPORT
void oskar_element_load_spherical_wave_coeff_galileo(oskar_Element* data,
