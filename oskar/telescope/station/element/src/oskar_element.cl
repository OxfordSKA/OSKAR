...
OSKAR_EVALUATE_GEOMETRIC_DIPOLE_PATTERN_SCALAR( M_CAT(evaluate_geometric_dipole_pattern_scalar_, Real), Real, Real2, Real4c)
OSKAR_EVALUATE_SPHERICAL_WAVE_SUM( M_CAT(evaluate_spherical_wave_sum_, Real), Real, Real2)
