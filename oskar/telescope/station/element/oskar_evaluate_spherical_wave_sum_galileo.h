...
#ifndef OSKAR_EVALUATE_SPHERICAL_WAVE_SUM_GALILEO_H_
#define OSKAR_EVALUATE_SPHERICAL_WAVE_SUM_GALILEO_H_

/**
 * @file oskar_evaluate_spherical_wave_sum_galileo.h
 */
