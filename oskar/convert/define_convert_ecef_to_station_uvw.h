...
#define OSKAR_CONVERT_ECEF_TO_STATION_UVW(NAME, FP) KERNEL(NAME) (\
        ...
        const FP sin_ha0, const FP cos_ha0, const FP sin_dec0, const FP cos_dec0,\
        const int offset_out, GLOBAL_OUT(FP, u), GLOBAL_OUT(FP, v), GLOBAL_OUT(FP, w))\
{\
