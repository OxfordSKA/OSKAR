...
TEST(Sky, load_named_columns_mixed_spectral_types)
{
    ...
    ASSERT_EQ(7, oskar_sky_int(sky, OSKAR_SKY_NUM_SOURCES));
    ASSERT_EQ(0.01, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 0));
    ASSERT_EQ(0.02, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 1));
    ASSERT_EQ(0.03, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 2));
    ASSERT_EQ(0.04, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 3));
    ASSERT_EQ(0.05, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 4));
    ASSERT_EQ(0.06, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 5));
    ASSERT_EQ(0.07, oskar_sky_data(sky, OSKAR_SKY_RA_RAD, 0, 6));
    ASSERT_EQ(0.1, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 0));
    ASSERT_EQ(0.2, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 1));
    ASSERT_EQ(0.3, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 2));
    ASSERT_EQ(0.4, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 3));
    ASSERT_EQ(0.5, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 4));
    ASSERT_EQ(0.6, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 5));
    ASSERT_EQ(0.7, oskar_sky_data(sky, OSKAR_SKY_DEC_RAD, 0, 6));
    ...
    ASSERT_EQ(3, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_I_JY, 5));
    ASSERT_EQ(4, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_I_JY, 6));
    ASSERT_EQ(1.1, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 0));
    ASSERT_EQ(1.2, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 1));
    ASSERT_EQ(1.3, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 2));
    ASSERT_EQ(1.4, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 3));
    ASSERT_EQ(1.5, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 4));
    ASSERT_EQ(1.6, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 5));
    ASSERT_EQ(1.7, oskar_sky_data(sky, OSKAR_SKY_I_JY, 1, 5));
    ASSERT_EQ(1.8, oskar_sky_data(sky, OSKAR_SKY_I_JY, 2, 5));
    ASSERT_EQ(1.7, oskar_sky_data(sky, OSKAR_SKY_I_JY, 0, 6));
    ASSERT_EQ(1.8, oskar_sky_data(sky, OSKAR_SKY_I_JY, 1, 6));
    ASSERT_EQ(1.9, oskar_sky_data(sky, OSKAR_SKY_I_JY, 2, 6));
    ASSERT_EQ(1.75, oskar_sky_data(sky, OSKAR_SKY_I_JY, 3, 6));
    ASSERT_EQ(1, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_REF_HZ, 0));
    ASSERT_EQ(1, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_REF_HZ, 1));
    ...
    ASSERT_EQ(3, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_REF_HZ, 5));
    ASSERT_EQ(4, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_REF_HZ, 6));
    ASSERT_EQ(100e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 0, 0));
    ...
    ASSERT_EQ(101e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 0, 5));
    ASSERT_EQ(102e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 1, 5));
    ASSERT_EQ(104e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 2, 5));
    ASSERT_EQ(101e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 0, 6));
    ASSERT_EQ(102.4e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 1, 6));
    ASSERT_EQ(103.8e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 2, 6));
    ASSERT_EQ(104.1e6, oskar_sky_data(sky, OSKAR_SKY_REF_HZ, 3, 6));
    ASSERT_EQ(1, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_IDX, 0));
    ASSERT_EQ(2, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_IDX, 1));
    ASSERT_EQ(3, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_IDX, 2));
    ASSERT_EQ(1, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_IDX, 3));
    ASSERT_EQ(0, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_IDX, 4));
    ...
    ASSERT_EQ(-0.55, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 0, 0));
    ASSERT_EQ(-0.7, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 0, 1));
    ASSERT_EQ(0.05, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 1, 1));
    ASSERT_EQ(0.08, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 0, 2));
    ASSERT_EQ(0.07, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 1, 2));
    ASSERT_EQ(0.02, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 2, 2));
    ASSERT_EQ(-0.6, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 0, 3));
    ASSERT_EQ(0.0,  oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 1, 3));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_SPEC_IDX, 0, 4));
    ...
    ASSERT_EQ(1, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_CURV, 3));
    ASSERT_EQ(0, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_SPEC_CURV, 4));
    ...
    ASSERT_EQ(0.1, oskar_sky_data(sky, OSKAR_SKY_SPEC_CURV, 0, 3));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_SPEC_CURV, 0, 4));
    ...
    ASSERT_EQ(1, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_LINE_WIDTH_HZ, 4));
    ASSERT_EQ(3, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_LINE_WIDTH_HZ, 5));
    ASSERT_EQ(0, oskar_sky_num_valid_columns_of_type(sky, OSKAR_SKY_LINE_WIDTH_HZ, 6));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 0, 0));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 0, 1));
    ASSERT_EQ(100e3, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 0, 4));
    ASSERT_EQ(250e3, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 0, 5));
    ASSERT_EQ(350e3, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 1, 5));
    ASSERT_EQ(500e3, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 2, 5));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 0, 6));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 1, 6));
    ASSERT_EQ(0.0, oskar_sky_data(sky, OSKAR_SKY_LINE_WIDTH_HZ, 2, 6));
    oskar_sky_free(sky, &status);
    (void) remove(name);
}
