...
def parse_setting_node(node, key, depth, count, latex_file=None):
    ...
    if type_node_ == None and depth == 1:
        ...
        latex_file_.write(r'\begin{longtable}{|L{0.4cm}|L{9cm}|p{8.5cm}|L{3.0cm}|L{1.7cm}|}' + '\n')
        latex_file_.write('\n')
        
        # Header for first page
        #latex_file_.write(r'\hline\hline \\[-2ex]'+'\n')
        latex_file_.write(r'\hline'+'\n')
        latex_file_.write(r'  \rowcolor{lightgray}'+'\n')
#         latex_file_.write(r'  \multicolumn{1}{l}{\textbf{ID}} &'+'\n')
#         latex_file_.write(r'  \multicolumn{1}{l}{\textbf{Key}} &'+'\n')
#         latex_file_.write(r'  \multicolumn{1}{l}{\textbf{Description}} &'+'\n')
#         latex_file_.write(r'  \multicolumn{1}{l}{\textbf{Allowed values}} &'+'\n')
#         latex_file_.write(r'  \multicolumn{1}{l}{\textbf{Default}} \\[0.5ex] \hline'+'\n')
        ...
        #latex_file_.write(r'  \\[-1.8ex]'+'\n')
        latex_file_.write(r'\endfirsthead'+'\n')
        # Header for remaining page(s)
        #latex_file_.write(r'\\multicolumn{5}{{\tablename} \thetable{} -- Continued} \\[0.5ex]'+'\n')
        #latex_file_.write(r'\hline\hline \\[-2ex]'+'\n')
        latex_file_.write(r'\hline'+'\n')
        latex_file_.write(r'  \rowcolor{lightgray}' + '\n')
        latex_file_.write(r'  {\textbf{ID}} &'+'\n')
...
#         latex_file_.write(r'  \multicolumn{1}{l}{\textbf{Default}} \\[0.5ex] \hline' + '\n')
        ...
        # Footer footer for the last page of the table...
        #latex_file_.write(r'  \\[-1.8ex] \hline \hline'+'\n')
        #latex_file_.write(r'  \\[-1.8ex] \hline \hline'+'\n')
        latex_file_.write(r'  '+'\n')
