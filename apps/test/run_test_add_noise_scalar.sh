...
#
# Description:
#   Tests the addition of noise to visibilties in Scalar mode.
#
# Method:
...
#   3. Report the noise on the Stokes-I visibilties.
...
rms=5  ## FIXME this should be single polarisation RMS .... ?
