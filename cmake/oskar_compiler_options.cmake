...
if (CUDA_FOUND)
    ...
    if (NOT DEFINED CUDA_ARCH)
        ...
        message("-- INFO:   5.0, 5.2, 6.0, 6.1, 6.2, 7.0, 7.5, 8.0, 8.6, or ALL.")
    ...
    foreach (ARCH ${CUDA_ARCH})
        if (ARCH MATCHES ALL|[Aa]ll)
            ...
            message("-- INFO: Maxwell, Pascal, Volta, Turing, and Ampere architectures")
        ...
        elseif (ARCH MATCHES 8.6)
            message("-- INFO: Building CUDA device code for architecture 8.6 (GeForce 30 Series)")
            list(APPEND CUDA_NVCC_FLAGS -gencode arch=compute_86,code=sm_86)
        else()
