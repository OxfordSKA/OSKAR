...
if (CASACORE_FOUND)
    # C++11 is now required for casacore headers.
    ...
    elseif (COMPILER_SUPPORTS_CXX0X)
        append_flags(CMAKE_CXX_FLAGS -std=c++0x)
    endif()
endif()
...
if (CUDA_FOUND)
    ...
    if (NOT DEFINED CUDA_ARCH)
        ...
        message("-- INFO:   5.0, 5.2, 6.0, 6.1, 6.2, 7.0, 7.2, 7.5 or ALL.")
    ...
    foreach (ARCH ${CUDA_ARCH})
        ...
        elseif (ARCH MATCHES 7.0)
            ...
            list(APPEND CUDA_NVCC_FLAGS -gencode arch=compute_70,code=sm_70)
        elseif (ARCH MATCHES 7.2)
            message("-- INFO: Building CUDA device code for architecture 7.2")
            list(APPEND CUDA_NVCC_FLAGS -gencode arch=compute_72,code=sm_72)
