...
if (CUDA_FOUND)
    ...
    if (NOT DEFINED CUDA_ARCH)
        ...
        message("-- INFO:   6.0, 6.1, 6.2, 7.0, 7.5, 8.0, 8.6 or ALL.")
        message("-- INFO: Note that ALL is currently most from 3.0 to 7.5.")
        message("-- INFO: Separate multiple architectures with semi-colons.")
    endif()
    foreach (ARCH ${CUDA_ARCH})
        if (ARCH MATCHES ALL|[Aa]ll)
            message("-- INFO: Building CUDA device code for most Kepler,")
