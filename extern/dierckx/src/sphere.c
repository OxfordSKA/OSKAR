...
void sphere_f(int iopt, int m, const float* theta, const float* phi,
        ...
        int* iwrk, int kwrk, int* ier)
{
    ...
    *ier = 0;
    ...
    lst = lcs + npest;
    lsp = lst + (m << 2);
    fpsphe_f(iopt, m, theta, phi, r, w, s, ntest, npest, eps, tol, maxit,
            ncc, nt, &tt[1], np, &tp[1], c, fp, &wrk1[1], &wrk1[lfp],
            &wrk1[lco], &wrk1[lf], &wrk1[lff], &wrk1[lro], &wrk1[lcc],
            &wrk1[lcs], &wrk1[la], &wrk1[lq], &wrk1[lbt], &wrk1[lbp],
            &wrk1[lst], &wrk1[lsp], &wrk1[lh], &iwrk[ki], &iwrk[kn], &wrk2[1],
            lwrk2, ier);
}

void sphere_d(int iopt, int m, const double* theta, const double* phi,
        const double* r, const double* w, double s, int ntest, int npest,
        double eps, int* nt, double* tt, int* np, double* tp, double* c,
        ...
        int* iwrk, int kwrk, int* ier)
{
    ...
    *ier = 0;
    ...
    lst = lcs + npest;
    lsp = lst + (m << 2);
    fpsphe_d(iopt, m, theta, phi, r, w, s, ntest, npest, eps, tol, maxit,
            ncc, nt, &tt[1], np, &tp[1], c, fp, &wrk1[1], &wrk1[lfp],
            &wrk1[lco], &wrk1[lf], &wrk1[lff], &wrk1[lro], &wrk1[lcc],
            &wrk1[lcs], &wrk1[la], &wrk1[lq], &wrk1[lbt], &wrk1[lbp],
            &wrk1[lst], &wrk1[lsp], &wrk1[lh], &iwrk[ki], &iwrk[kn], &wrk2[1],
